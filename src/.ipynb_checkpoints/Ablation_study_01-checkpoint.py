...
if __name__ == "__main__":
    ...
    for seed in [ 2]:
            ...
            model = train(mixed, decoder, device, steps=NB_STEPS,base_name=f"bal0p3_seed{seed}")
    
            save_checkpoint(model, None, step=NB_STEPS, extra={"seed": seed}, base_name=f"final_bal0p3_seed{seed}")
